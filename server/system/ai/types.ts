...
// Context handed to the proposition model: the full current version and the trials
...
// Raw next-version proposition produced by Gemini — a full ingredient/step list
