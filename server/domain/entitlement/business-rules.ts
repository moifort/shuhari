...
// change it and every entitlement already sold stops matching its cook.
const TOKEN_NAMESPACE = '6f9e2a1c-8b3d-4c5e-9f1a-2d7b4e6a8c30'
...
// variant bits forced) of the cook's id — derived rather than stored, so it needs
...
// Whether the App Store still owes this cook their Premium. A refund revokes it
...
// The plan a cook is on. Absent entitlement, expired entitlement, revoked
