...
- Première version : import de recettes assisté par IA, boucle d'expérimentation (exécuter, noter, itérer), propositions d'itération une-variable-à-la-fois, promotion de version et variations.
